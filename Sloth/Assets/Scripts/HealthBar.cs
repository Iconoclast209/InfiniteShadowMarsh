...
//UNDONE: Removed because unknown implementation method
///<summary>Handles Health Bar Functionality</summary>
public class HealthBar : MonoBehaviour
{
    ...
    /// <summary>Calculate perentage of health remaining and use that to resize the health bar UI</summary>
    ...
    /// <summary>Calculate percentage of health remaining getting the current health and calculating it with the max health determined in Start() and the HUNDRED_PERCENT constant.</summary>
    ...
    /// <summary>Resizes health bar UI based on the percentage of health remaining and starting width of the health bar UI</summary>
