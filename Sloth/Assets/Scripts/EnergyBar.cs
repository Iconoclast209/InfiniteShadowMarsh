...
//TODO: Fix implementation to function with HUD Manager
///<summary>Energy Bar functionality for resizing.</summary>
public class EnergyBar : MonoBehaviour
{
    ...
    /// <summary>Early set-up.  Initialize values and get internal references.</summary>
    private void Awake()
    {
    ...
    /// <summary> Set-up involving third-parties.  </summary>
    private void Start()
    {
    ...
    /// <summary>Calculate perentage of energy remaining and use that to resize the energy bar UI</summary>
    ...
    /// <summary>Calculate percentage of energy remaining getting the current energy and calculating it with the max energy determined in Start() and the HUNDRED_PERCENT constant.</summary>
    ...
    /// <summary>Resizes energy bar UI based on the percentage of energy remaining and starting width of the energy bar UI</summary>
